...
<script type="text/javascript" src="/styles/index.js" defer></script>
<title>The 43rd Street</title>
</head>
<body
	class="scrollbar-thin scrollbar-thumb-gray-900 scrollbar-track-gray-300 hover:scrollbar-thumb-gray-700 bg-gray-200 font-primary text-primary caret-gray-700 selection:bg-gray-500 selection:text-white flex flex-col h-screen items-center">
	<nav
		...
		<div class="flex items-center gap-5">
			<div class="flex text-sm gap-5">
				<a href="homePage"><h4 class="font-bold cursor-pointer">Home</h4></a>
				<a href="kitchenPage">
	...
	<main class="px-36 py-10 w-full h-full">
		<div class="flex flex-col gap-10 justify-center h-full">
			<h1 class="text-2xl text-center">Welcome,
				${sessionCustomer.userName} !</h1>
			<div class="flex justify-evenly items-center">
				<div id="kitchenCarousel"
					class="transition hover:scale-110 duration-300 ease-out">
					<a href="/kitchenPage"><img src="./images/home/kitchen-1.png"
						alt="Kitchen Image" class="h-64" id="kitchenImage" />
						<p
							class="bg-primary text-white font-bold text-center py-3 text-lg">
							Kitchen</p></a>
				</div>
				<div class="transition hover:scale-110 duration-300 ease-out"
					id="gardenCarousel">
					<a href="/gardenPage"><img src="./images/home/garden-1.png"
						alt="Garden Image" class="h-64" id="gardenImage" />
						<p
							class="bg-primary text-white font-bold text-center py-3 text-lg">
							Garden</p></a>
				</div>
				<div class="transition hover:scale-110 duration-300 ease-out"
					id="officeCarousel">
					<a href="/officePage"><img src="./images/home/office-1.png"
						alt="Office Image" class="h-64" id="officeImage" />
						<p
							class="bg-primary text-white font-bold text-center py-3 text-lg">
							Office</p></a>
				</div>
