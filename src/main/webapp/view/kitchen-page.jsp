...
<body
		...
		<div class="flex items-center gap-5">
			<div class="flex text-sm gap-5">
				<a href="homePage">
					...
					<h4 class="font-bold cursor-pointer">Kitchen</h4>
				</a> <a href="gardenPage">
	...
	<main class="px-36 py-10 w-full h-full min-h-[calc(100vh-10rem)]">
		<h1 class="text-center text-4xl font-bold">Kitchen</h1>
		<div class="flex flex-wrap gap-5 mt-6 justify-center">
			<c:forEach var="tempProd" items="${products}">
				<div
					...
					<form method="post" action="/kitchenCart"
						...
						<input type="number" min="0"
							...
							name="KproductCategory" value="1"> <input type="hidden"
							name="KproductId" value="${tempProd.id}">
