...
<body
	...
	<div
		...
		<form:form enctype="multipart/form-data" action="/saveGardenProduct" class="flex flex-col gap-4 mt-6" id="addForm" modelAttribute="prodModel">
