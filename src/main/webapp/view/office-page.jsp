...
<body
		...
		<div class="flex items-center gap-5">
			<div class="flex text-sm gap-5">
				<a href="homePage">
					...
					<h4 class="font-bold cursor-pointer">Office</h4>
				</a>
			</div>
	...
	<main class="px-36 py-10 w-full h-full min-h-[calc(100vh-10rem)]">
		<h1 class="text-center text-4xl font-bold">Office</h1>
		<div class="flex flex-wrap gap-5 mt-6 justify-center">
			<c:forEach var="tempProd" items="${products}">
				<div
					...
					<form method="post" action="/officeCart"
						...
						<input type="number" min="0"
							...
							name="OproductCategory" value="3"> <input type="hidden"
							name="OproductId" value="${tempProd.id}">
