...
<script src="/styles/admin-add.js" defer></script>
<title>Add Kitchen Item</title>
</head>
<body
	...
	<div
		...
		<h1 class="text-3xl font-bold text-center">Add Item</h1>
		<form:form enctype="multipart/form-data" action="/saveKitchenProduct" class="flex flex-col gap-4 mt-6" id="addForm" modelAttribute="prodModel">
			<div class="flex flex-col">
				<label for="prodName" class="form-label"> Product Name </label> <form:input path="name"
					type="text" name="prodName" id="prodName" class="form-input" />
			</div>
			<div class="flex flex-col">
				<label for="prodPrice" class="form-label"> Product Price </label> <form:input path="price"
					type="number" min="0"
			...
			<div class="flex flex-col">
				<label for="prodDesc" class="form-label"> Product
					Description </label>
				<form:textarea path="description" name="prodDesc" id="prodDesc" cols="30" rows="3"
			...
			<a href="/admin" class="text-xs underline underline-offset-1 font-bold">Go
				Back</a>
		</form:form>
	</div>
</body>
